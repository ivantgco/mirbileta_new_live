    ...
    */
    ...
    <body <?php body_class(); ?> data-page="inner">
        ...
        <div class="site-content white-bg action-page">
            <div class="site-container action-container">
                ...
                <div class="mb-site-content">
                    ...
                    <div class="a-image-reviews-holder">
                        ...
                        <div class="image-gallery-holder">
                            ...
                            <!--                        </div>-->
                            <?php
                            $a_youtube_link = get_field("a_youtube_link", $post->ID);
                            if (!empty($a_youtube_link)) {
                                echo '<div class="a_youtube_video"><iframe width="577" height="500" src="' . $a_youtube_link . '"></iframe></div>';
                            }
                            ?>
                        ...
                        <div class="action-title-wrap">
                            ...
                            <div class="action-date"><i class="fa fa-calendar"></i><?php echo $act_date . ' ' . $act_date_year; ?> <span class="weekday">(<?php echo $weekday_short; ?>)</span> <?php echo $act_time; ?> <?php echo $another_date_link; ?></div>
                            ...
                            <div class="action-venue"><i class="fa fa-map-marker"></i><a href="/<?php echo $venue_alias; ?>/" target="_blank"><?php echo $venue; ?></a><?php echo $show_hall; ?></div>
                    ...
                    <?php if (strlen($description) > 5) : ?>
                        ...
                        <div class="action-description">
                            ...
                            <div title="<?php echo $act_name; ?> Купить билеты" class="action-buy-button desc-action-buy-btn">Купить билеты</div>
    ...
    <p class="button-text">Купить билет</p>
        ...
        <div class="modal-widget-holder">
            <div class="modal-widget-inner">
                ...
                <div id="multibooker-widget-wrapper" data-actions="<?php echo $widget_act_id; ?>" data-mirbileta="true" data-frame="<?php echo $widget_frame; ?>" data-host=<?php echo $global_prot . "://" . $global_url . '/'; ?> data-ip="<?php echo $global_url; ?>">
        ...
        if ($free_places > 0) {
            ...
            <!--        <script type="text/javascript" src="--><?php //echo $global_prot .'://'. $global_url
                                                                    ?>
            <!--/assets/widget/afisha.js"></script>-->
