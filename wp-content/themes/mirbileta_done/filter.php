...
if (strlen($from_date) > 0) {
    $url .= '<from_date>' . $from_date . '</from_date>';
}
if (strlen($to_date) > 0) {
    $url .= '<to_date>' . $to_date . '</to_date>';
}
if (strlen($search_keyword) > 0) {
    $url .= '<search_keyword>' . $search_keyword . '</search_keyword>';
}
...
if (strlen($show_type_alias) > 0) {
    $url .= '<show_type_alias>' . $show_type_alias . '</show_type_alias>';
}
                ...
                <div class="filter-page-content">
                    <div class="filter-page-filters-wrapper">
                        <div class="">
                            ...
                            <div class="">
                                <div class="mb-tf-block" data-filter="price" data-inputs="false"></div>
                            </div>
                        </div>
