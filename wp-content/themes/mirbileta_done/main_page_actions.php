...
$url =  $global_prot . "://" . $global_url . "/cgi-bin/site?request=<command>get_afisha</command><url>" . $global_salesite . "</url><page_no>1</page_no><rows_max_num>25</rows_max_num>";
...
$show_next_button = $actions_count == 25;
...
<?php if ($show_next_button) : ?>
    ...
    <div id="load_next" class="load_next_style_1"><span>Смотреть все билеты</span></div>
