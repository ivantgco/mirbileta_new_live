                ...
                <div class="mb-actor-image-and-desc">
                    ...
                    <div class="col-md-6">
                        ...
                        if ($mb_page_cont !== '') {
                            ...
                            echo $data[array_search("DESCRIPTION", $columns)];
                        }
...
<!--    <link rel="pingback" href="--><?php //bloginfo('pingback_url'); 
                                        ?>
<!--">-->
<!--    <link rel='stylesheet' id='main-style' href='--><?php //echo get_stylesheet_uri(); 
                                                        ?>
...
<!---->
<!--            <h2 class="padLeft25">--><?php //echo $data[array_search("ACTOR_NAME", $columns)]; 
                                            ?>
<!--</h2>-->
<!---->
<!--            <div class="single-image-holder pr30"style="background-image: url('--><?php //echo $data[array_search("URL_IMAGE_BIG", $columns)]; 
                                                                                        ?>
<!--')"></div>-->
<!---->
<!--            <div class="pr70">-->
