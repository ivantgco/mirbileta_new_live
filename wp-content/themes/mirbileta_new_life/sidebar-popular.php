...
$url =  $global_prot ."://". $global_url . "/cgi-bin/site?request=<command>get_actions</command><url>".$global_salesite."</url><ACTION_IS_IMPORTANT>TRUE</ACTION_IS_IMPORTANT><page_no>1</page_no><rows_max_num>5</rows_max_num>";
...
<div class="sidebar-title">
    <div class="sidebar-popular-toggler"></div>
...
//        $thumb =        (strpos("http" , $value[array_search("ACTION_POSTER_THUMBNAIL_IMAGE", $columns)]) == -1)? 'https://shop.mirbileta.ru/upload/' . $value[array_search("ACTION_POSTER_THUMBNAIL_IMAGE", $columns)]: $value[array_search("ACTION_POSTER_THUMBNAIL_IMAGE", $columns)];
        ...
        $actionsHtml .= '<a href="/'.$alias.'"><h3 class="sidebar-popular-action">'.$act_name.'</h3></a>';
